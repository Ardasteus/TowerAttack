#include "furthest_attack_mode.h"
#include "core/game_manager/game_manager.h"
#include "game/attacker_entity/attacker_entity.h"

FurthestAttackMode::FurthestAttackMode()
: AttackMode(AttackType::Furthest)
{
    
}

vector<shared_ptr<AttackerEntity>> FurthestAttackMode::GetAttackersToDamage(const IVector2& position, const int& radius, GameManager& game_manager) const
{
